...
(defpackage "https://github.com/g000001/rmscl"
  (:nicknames #:rmscl)
  (:shadow #:member #:delete #:set-exclusive-or #:intersection #:sublis #:union 
           #:search #:subst #:remove #:nsubstitute #:nset-difference #:nsublis #:adjoin 
           #:delete-duplicates #:nset-exclusive-or #:count #:nunion #:tree-equal 
           #:remove-duplicates #:set-difference #:mismatch #:position #:nintersection
           #:nsubst #:find #:subsetp #:make-hash-table
           #:let)
  (:use #:common-lisp #:lambda.output)
  (:export #:rmscl-syntax #:in-syntax)
  (:export #:compose)
  (:export #:onum #:ofloat #:ochar #:ostring #:oprint #:plural #:pad #:tab #:breakline
           #:output #:outfmt)
  (:export #:&allow-other-keys #:&aux #:&body #:&environment #:&key #:&optional
           ...
           #:fmakunbound #:force-output #:fourth
           ...
           #:multiple-values-limit #:name-char
           ...
           #:serious-condition #:set-difference
...
(defpackage "https://github.com/g000001/rmscl#internals"
  (:use "https://github.com/g000001/rmscl"))
